...
export const BentoGridItem = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-xl opacity-0 group-hover/bento:opacity-100 transition duration-200">
        <div className="absolute inset-[1px] rounded-xl bg-slate-950" />
        <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-cyan-500 via-purple-500 to-cyan-500 opacity-50 blur-sm" />
      </div>
