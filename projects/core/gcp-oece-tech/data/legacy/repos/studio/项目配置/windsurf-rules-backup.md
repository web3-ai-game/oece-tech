...
**Deployment**:
- VPS: 134.209.142.24 (DigitalOcean Reserved IP)
- 外挂盘: /mnt/external-ssd/svs/studio
- PM2 process manager
...
3. Copy the content from PART 1 (see windsurf-global-rules.md)
...
3. Copy the content from THIS FILE
