        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-warm-300">
                <li><button className="hover:text-white">技术支持</button></li>
                <li><button className="hover:text-white">文档中心</button></li>
                <li><button className="hover:text-white">培训服务</button></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-warm-300">
                <li><button className="hover:text-white">公司介绍</button></li>
