      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-gray-800 rounded-xl shadow-2xl p-8">
          ...
          <div className="mt-4 p-3 bg-gradient-to-r from-blue-900/50 to-purple-900/50 rounded-lg border border-blue-700/30">
            <p className="text-xs text-blue-300 mb-2">🚀 <strong>SVS + TT 测试账户</strong></p>
            <div className="space-y-1 text-xs text-gray-300">
              <div>👑 <span className="text-yellow-300">管理员</span>: svs@tt.com / svs123</div>
              <div>⭐ <span className="text-purple-300">经理</span>: svs.tt@hotel.com / tt2024</div>
              <div>👤 <span className="text-blue-300">员工</span>: svstt@inistel.com / svs-tt</div>
              <div>🎯 <span className="text-green-300">演示</span>: ttsvs@gmail.com / ttsvs123</div>
            </div>
          </div>
